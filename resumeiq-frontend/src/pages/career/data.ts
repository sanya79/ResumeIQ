...
export const targetRoles: TargetRoleOption[] = [
  ...
  { value: "data-scientist", label: "Data Scientist", group: "Data" },
  { value: "machine-learning-engineer", label: "Machine Learning Engineer", group: "Data" },
  { value: "devops-engineer", label: "DevOps Engineer", group: "Infrastructure" },
  { value: "cloud-engineer", label: "Cloud Engineer", group: "Infrastructure" },
  { value: "cyber-security-analyst", label: "Cyber Security Analyst", group: "Infrastructure" },
  { value: "ui-ux-designer", label: "UI/UX Designer", group: "Design" },
];
